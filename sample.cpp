...
GLuint BoxList, DuckyDL;		 // object display list
...
Xpos1.Init( );
	Xpos1.AddTimeValue(  0.0,  10 );
	Xpos1.AddTimeValue(  0.5,  4 );
	Xpos1.AddTimeValue(  2.0,  0.3 );
	Xpos1.AddTimeValue(  5.0,  1 );
	Xpos1.AddTimeValue(  8.0,  8 );
	Xpos1.AddTimeValue( 10.0,  12 );
